 ...
 * @date 2017/3/21.
 */
public class StartEngineMessage implements IMessage{
    ...
    public BaseMessage produceAckMessage(long sequenceId,Identity identity) {
        ...
        applicationHeader.setApplicationID(ApplicationID.START_CAR);
    ...
    public BaseMessage produceResultMessage(long sequenceId,Identity identity) {
        ...
        EnableEngineStartNotifyRawData rawData = new EnableEngineStartNotifyRawData();
        rawData.setStatus(EnableEngineStartNotifyRawData.Status.SUCCESS);
    ...
    public static void main(String...args){
        ...
        Gson gson = new Gson();
        BaseMessage baseMessage = new StartEngineMessage().produceResultMessage(1000,identity);
