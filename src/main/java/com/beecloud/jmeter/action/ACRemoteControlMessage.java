 ...
 * @date 2017/3/21.
 */
public class ACRemoteControlMessage implements IMessage{
    ...
    public BaseMessage produceResultMessage(long sequenceId,Identity identity) {
        ...
        List<Result> resultList= Lists.newArrayList(new Result(ConfigTable.REFRIGERATION_SWITCH,FunctionResultType.SUCCESS),
                new Result(ConfigTable.TEMPERATURE, FunctionResultType.SUCCESS));
    ...
    public static void main(String...args){
        ...
        Gson gson = new Gson();
        BaseMessage baseMessage = new ACRemoteControlMessage().produceResultMessage(1000,identity);
